...
device_parameter = input(f'Enter device parameter ({", ".join(london_co[device_name].keys())}): ').lower()
print(london_co[device_name].get(device_parameter, 'No such parameter'))
